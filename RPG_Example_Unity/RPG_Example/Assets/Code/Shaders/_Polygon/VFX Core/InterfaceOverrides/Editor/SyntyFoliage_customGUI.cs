...
public override void OnGUI(MaterialEditor materialEditor, MaterialProperty[] properties)
{
    ...
    switch (selectedTab)
    {
        case 0: DrawLeafSettings(materialEditor, properties);    break;
        case 1: DrawTrunkSettings(materialEditor, properties);   break;
        case 2: DrawFrostingSettings(materialEditor, properties); break;
        case 3: DrawEmissionSettings(materialEditor, properties); break;
        case 4: DrawWindSettings(materialEditor, properties);    break;
    }
    ...
    // Renders the GPU Instancing toggle hidden by the custom GUI
    materialEditor.EnableInstancingField();
    
    // Double sided GI: leaves receive baked light from both faces
